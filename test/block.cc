...
TEST (Block, clone) {
...

	{
		...
		EXPECT_EQ(block.clone()->draw_as_latex(),
			"\\begin{colorblock}{0000FF}{FFFFFF}{lorem ipsum}\n"
			"\\end{colorblock}");
		...
		EXPECT_EQ(block.clone()->draw_as_latex(),
			"\\begin{colorblock}{00FFFF}{000000}{lorem ipsum}\n"
			"$a^2 + b^2 + c^2 = d^2$ - easy equation\n"
			"\\begin{itemize}\n"
			"\\item aaa\n"
			"\\item bbb\n"
...

	{
		...
		EXPECT_EQ(block.clone()->draw_as_latex(),
			"\\begin{colorblock}{FF00FF}{FFFFFF}{lorem ipsum}\n"
			"\\end{colorblock}");

		block.set_title("abc efg");
		EXPECT_EQ(block.clone()->draw_as_latex(),
			"\\begin{colorblock}{FF00FF}{FFFFFF}{abc efg}\n"
			"\\end{colorblock}");
	}

	{
		Block block("lorem ipsum", Color::MAGENTA,
			Latex("$a^2 + b^2 + c^2 = d^2$ - easy equation"));
		EXPECT_EQ(block.clone()->draw_as_latex(),
			"\\begin{colorblock}{FF00FF}{FFFFFF}{lorem ipsum}\n"
			"$a^2 + b^2 + c^2 = d^2$ - easy equation\n"
			"\\end{colorblock}");
